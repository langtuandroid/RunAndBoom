...
using JustAssets.AtlasMapPacker;
using UnityEngine;
...
namespace QuadTreeLib
{
    ...
    public class QuadTreeNode<T> where T : IHasRect
    {
        ...
        /// Is the node empty
        /// </summary>
        public bool IsEmpty { get { return m_bounds.width*m_bounds.height==0f || m_nodes.Count == 0; } }
        ...
        private void CreateSubNodes()
        {
            ...
            m_nodes.Add(new QuadTreeNode<T>(new Rect(m_bounds.position, new Vector2(halfWidth, halfHeight))));
            m_nodes.Add(new QuadTreeNode<T>(new Rect(new Vector2(m_bounds.x, m_bounds.y + halfHeight), new Vector2(halfWidth, halfHeight))));
            m_nodes.Add(new QuadTreeNode<T>(new Rect(new Vector2(m_bounds.x + halfWidth, m_bounds.y), new Vector2(halfWidth, halfHeight))));
            m_nodes.Add(new QuadTreeNode<T>(new Rect(new Vector2(m_bounds.x + halfWidth, m_bounds.y + halfHeight), new Vector2(halfWidth, halfHeight))));
        }
